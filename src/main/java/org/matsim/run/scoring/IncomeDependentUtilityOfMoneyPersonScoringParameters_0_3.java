 ...
 */
public class IncomeDependentUtilityOfMoneyPersonScoringParameters_0_3 implements ScoringParametersForPerson {
    Logger log = LogManager.getLogger(IncomeDependentUtilityOfMoneyPersonScoringParameters_0_3.class);
    ...
    @Inject
    IncomeDependentUtilityOfMoneyPersonScoringParameters_0_3(Population population, ScoringConfigGroup scoringConfigGroup, ScenarioConfigGroup scenarioConfigGroup, TransitConfigGroup transitConfigGroup) {
    ...
    public ScoringParameters getScoringParameters(Person person) {
        ...
        if (scoringParametersForThisPerson == null) {
            ...
            if (PersonUtils.getIncome(person) != null) {
                ...
                if (personalIncome > 0) {
                    builder.setMarginalUtilityOfMoney(Math.pow(subpopulationScoringParams.getMarginalUtilityOfMoney() * globalAvgIncome / personalIncome, 0.3));
                } else {
