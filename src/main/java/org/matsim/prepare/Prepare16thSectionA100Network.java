...
public class Prepare16thSectionA100Network implements MATSimAppCommand {
	...
	public static void add16thSectionA100Links(Network network) {
		...
		//TODO: check whether these examples are sensible

		// 3 lanes -- 22.225 free speed -- 5703.0 capacity
		Link exampleAutobahnLink = network.getLinks().get(Id.createLinkId("253770361#0"));
		// 2 lanes -- 14.465 free speed -- 3556.0 capacity
		Link exampleConnectorToA100 = network.getLinks().get(Id.createLinkId("24159735#0"));
		// 3 lanes --  8.844 free speed -- 2667.0 capacity
		Link exampleConnectorFromA100 = network.getLinks().get(Id.createLinkId("5095581#0"));
